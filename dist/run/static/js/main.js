...
(function() {
    ...
    function getUnmaskedContext(workInProgress, Component4, didPushOwnContextIfProvider) {
        {
    ...
    function renderWithHooks(current, workInProgress, Component7, props, secondArg, nextRenderLanes) {
    ...
    function updateForwardRef(current, workInProgress, Component8, nextProps, renderLanes) {
        {
    ...
    function updateMemoComponent(current, workInProgress, Component9, nextProps, updateLanes, renderLanes) {
        if (current === null) {
            var type = Component9.type;
            if (isSimpleFunctionComponent(type) && Component9.compare === null && Component9.defaultProps === undefined) {
            ...
            var child = createFiberFromTypeAndProps(Component9.type, null, nextProps, workInProgress, workInProgress.mode, renderLanes);
    ...
    function updateSimpleMemoComponent(current, workInProgress, Component10, nextProps, updateLanes, renderLanes) {
        {
            if (workInProgress.type !== workInProgress.elementType) {
        ...
        return updateFunctionComponent(current, workInProgress, Component10, nextProps, renderLanes);
    }
    ...
    function updateFunctionComponent(current, workInProgress, Component11, nextProps, renderLanes) {
        {
            if (workInProgress.type !== workInProgress.elementType) {
        ...
        var context;
        {
            var unmaskedContext = getUnmaskedContext(workInProgress, Component11, true);
        ...
        prepareToReadContext(workInProgress, renderLanes);
        {
            ReactCurrentOwner$1.current = workInProgress;
            setIsRendering(true);
            nextChildren = renderWithHooks(current, workInProgress, Component11, nextProps, context, renderLanes);
            if (workInProgress.mode & StrictMode1) {
                disableLogs();
                try {
                    nextChildren = renderWithHooks(current, workInProgress, Component11, nextProps, context, renderLanes);
    ...
    function updateClassComponent(current, workInProgress, Component12, nextProps, renderLanes) {
        {
            if (workInProgress.type !== workInProgress.elementType) {
                var innerPropTypes = Component12.propTypes;
                if (innerPropTypes) {
                    checkPropTypes(innerPropTypes, nextProps, "prop", getComponentName(Component12));
                }
            }
        }
        var hasContext;
        ...
        if (instance === null) {
            ...
            constructClassInstance(workInProgress, Component12, nextProps);
            mountClassInstance(workInProgress, Component12, nextProps, renderLanes);
            shouldUpdate = true;
        } else if (current === null) {
            shouldUpdate = resumeMountClassInstance(workInProgress, Component12, nextProps, renderLanes);
        } else {
            shouldUpdate = updateClassInstance(current, workInProgress, Component12, nextProps, renderLanes);
        }
        var nextUnitOfWork = finishClassComponent(current, workInProgress, Component12, shouldUpdate, hasContext, renderLanes);
        {
    ...
    function finishClassComponent(current, workInProgress, Component13, shouldUpdate, hasContext, renderLanes) {
        markRef(current, workInProgress);
        var didCaptureError = (workInProgress.flags & DidCapture) !== NoFlags;
        if (!shouldUpdate && !didCaptureError) {
            if (hasContext) {
                invalidateContextProvider(workInProgress, Component13, false);
            }
            return bailoutOnAlreadyFinishedWork(current, workInProgress, renderLanes);
        }
        var instance = workInProgress.stateNode;
        ...
        if (hasContext) {
            invalidateContextProvider(workInProgress, Component13, true);
        }
        return workInProgress.child;
    }
    ...
    function mountLazyComponent(_current, workInProgress, elementType, updateLanes, renderLanes) {
        ...
        workInProgress.type = Component14;
        var resolvedTag = workInProgress.tag = resolveLazyComponentTag(Component14);
                ...
                {
                    {
                        ...
                        workInProgress.type = Component14 = resolveFunctionForHotReloading(Component14);
                    }
                    child = updateFunctionComponent(null, workInProgress, Component14, resolvedProps, renderLanes);
                    return child;
                }
            case ClassComponent:
                {
                    {
                        workInProgress.type = Component14 = resolveClassForHotReloading(Component14);
                    }
                    child = updateClassComponent(null, workInProgress, Component14, resolvedProps, renderLanes);
                    return child;
                }
            case ForwardRef:
                {
                    {
                        workInProgress.type = Component14 = resolveForwardRefForHotReloading(Component14);
                    }
                    child = updateForwardRef(null, workInProgress, Component14, resolvedProps, renderLanes);
                    return child;
                }
            case MemoComponent:
                {
                    {
                        if (workInProgress.type !== workInProgress.elementType) {
                            ...
                            if (outerPropTypes) {
                                checkPropTypes(outerPropTypes, resolvedProps, "prop", getComponentName(Component14));
                            }
                        }
                    }
                    child = updateMemoComponent(null, workInProgress, Component14, resolveDefaultProps(Component14.type, resolvedProps), updateLanes, renderLanes);
                    return child;
                }
        }
        var hint = "";
        ...
        {
            {
                throw Error("Element type is invalid. Received a promise that resolves to: " + Component14 + ". Lazy element type must resolve to a class or function." + hint);
            }
        }
    }
    function mountIncompleteClassComponent(_current, workInProgress, Component15, nextProps, renderLanes) {
        if (_current !== null) {
            _current.alternate = null;
            workInProgress.alternate = null;
            workInProgress.flags |= Placement;
        ...
        prepareToReadContext(workInProgress, renderLanes);
        constructClassInstance(workInProgress, Component15, nextProps);
        mountClassInstance(workInProgress, Component15, nextProps, renderLanes);
        return finishClassComponent(null, workInProgress, Component15, true, hasContext, renderLanes);
    }
    function mountIndeterminateComponent(_current, workInProgress, Component16, renderLanes) {
        if (_current !== null) {
            _current.alternate = null;
            workInProgress.alternate = null;
            workInProgress.flags |= Placement;
        ...
        var context;
        {
            var unmaskedContext = getUnmaskedContext(workInProgress, Component16, false);
            context = getMaskedContext(workInProgress, unmaskedContext);
        }
        prepareToReadContext(workInProgress, renderLanes);
        var value;
        {
            if (Component16.prototype && typeof Component16.prototype.render === "function") {
                var componentName = getComponentName(Component16) || "Unknown";
            ...
            setIsRendering(true);
            ReactCurrentOwner$1.current = workInProgress;
            value = renderWithHooks(null, workInProgress, Component16, props, context, renderLanes);
            setIsRendering(false);
        }
        workInProgress.flags |= PerformedWork;
        {
            if (typeof value === "object" && value !== null && typeof value.render === "function" && value.$$typeof === undefined) {
                var _componentName = getComponentName(Component16) || "Unknown";
        ...
        if (typeof value === "object" && value !== null && typeof value.render === "function" && value.$$typeof === undefined) {
            {
                var _componentName2 = getComponentName(Component16) || "Unknown";
            ...
            initializeUpdateQueue(workInProgress);
            var getDerivedStateFromProps = Component16.getDerivedStateFromProps;
            if (typeof getDerivedStateFromProps === "function") {
                applyDerivedStateFromProps(workInProgress, Component16, getDerivedStateFromProps, props);
            }
            adoptClassInstance(workInProgress, value);
            mountClassInstance(workInProgress, Component16, props, renderLanes);
            return finishClassComponent(null, workInProgress, Component16, true, hasContext, renderLanes);
        } else {
            ...
            {
                validateFunctionComponentInDev(workInProgress, Component16);
            }
            return workInProgress.child;
        }
    }
    function validateFunctionComponentInDev(workInProgress, Component17) {
        {
            if (Component17) {
                if (Component17.childContextTypes) {
                    error1("%s(...): childContextTypes cannot be defined on a function component.", Component17.displayName || Component17.name || "Component");
                }
            }
            ...
            if (typeof Component17.getDerivedStateFromProps === "function") {
                var _componentName3 = getComponentName(Component17) || "Unknown";
            ...
            if (typeof Component17.contextType === "object" && Component17.contextType !== null) {
                var _componentName4 = getComponentName(Component17) || "Unknown";
    ...
    function completeWork(current, workInProgress, renderLanes) {
        ...
        switch(workInProgress.tag){
            ...
            case ClassComponent:
                {
                    var Component19 = workInProgress.type;
    ...
    function unwindWork(workInProgress, renderLanes) {
        switch(workInProgress.tag){
            case ClassComponent:
                {
                    var Component20 = workInProgress.type;
    ...
    function shouldConstruct$1(Component21) {
    ...
    function resolveLazyComponentTag(Component22) {
        if (typeof Component22 === "function") {
            return shouldConstruct$1(Component22) ? ClassComponent : FunctionComponent;
        } else if (Component22 !== undefined && Component22 !== null) {
            var $$typeof = Component22.$$typeof;
    ...
    function getContextForSubtree(parentComponent) {
        ...
        if (fiber.tag === ClassComponent) {
            var Component23 = fiber.type;
            if (isContextProvider(Component23)) {
                return processChildContext(fiber, Component23, parentContext);
            }
        }
        return parentContext;
    }
